    ...
    <div className="container">
      ...
      <section className="hero">
        ...
        <div className="hero-image">
          <img src="../src/apple4.jpg" alt="iPhone 13" />
        </div>
      </section>
      <section className="features">
        <div className="feature">
          <img src="../src/apple packgage1.jpg" alt="Feature 1" />
        ...
        <div className="feature">
          <img src="../src/camera.jpeg" alt="Feature 2" />
        ...
        <div className="feature">
          <img src="../src/phone.jpg" alt="Feature 3" />
        ...
        <div className="feature">
  <img src="../src/battery.jpeg" alt="Feature 4" />
...
<div className="feature">
  <img src="../src/security.jpeg" alt="Feature 5" />
...
<div className="feature">
  <img src="../src/5Gconection.jpg" alt="Feature 6" />
